...
@rem ##########################################################################
@rem
@rem  griffon-wslite startup script for Windows
@rem
@rem ##########################################################################
...
@rem Execute griffon-wslite
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SAMPLE_OPTS%  -classpath "%CLASSPATH%" io.github.aretche.griffonWslite.Launcher %CMD_LINE_ARGS%
